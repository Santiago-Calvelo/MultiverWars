...
public class Bloon extends FlyCharacter{
    public Bloon(String texture, int hitboxWidth, int hitboxHeight, Texture walkTexture, String attackTexture, float x, float y, int lives, int speed, EntityManager entityManager, String type, float attackCooldown, int damage, int energy, boolean canBeAttacked) {
